...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!collectionId) {
      throw new Error('collection_id parameter is required');
    }

    console.log(`Fetching products for collection: ${collectionId}, page=${page}, limit=${limit}`);
    ...
    console.log(`Returning ${shiprocketProducts.length} products for collection ${collectionId}`);
    ...
    console.error('Error in catalog products by collection:', error);
